const token = "BQA6DQu9qRwDwpZfOZ2U-G0yyO4k2DkCWubOf0vKGJsSQNHKKZQ8z9_cjrwWRSGaQ2AC6hKExi-jDE0XchlFgSyklhbYU-8VPc_RHhwcOZSS_aNJ9e8"
...
async function searchSongs() {
  ...
  const response = await fetchWebApi(`v1/search?q=${searchQuery}&type=track&limit=8`, 'GET');
  console.log(response);
